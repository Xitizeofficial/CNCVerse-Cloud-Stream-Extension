...
class IptvPlaylistParser {
    ...
    fun parseM3U(input: InputStream): Playlist {
        ...
        while (i < allLines.size) {
            ...
            if (line.isNotEmpty()) {
                when {
                    line.startsWith(SportzxProvider.EXT_INF) -> {
                    ...
                    line.startsWith(SportzxProvider.EXT_VLC_OPT) -> {
    ...
    private fun String.isExtendedM3u(): Boolean =
        startsWith(SportzxProvider.EXT_M3U) || startsWith(SportzxProvider.EXT_INF) || startsWith("#KODIPROP")
